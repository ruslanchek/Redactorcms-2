(function (e, t) {
    ...
    i(l, [], function () {
        ...
        var e = "Январь Февраль Март Апрель Май Июнь Июль Август Сентябрь Октябрь Ноябрь Декабрь".split(" "),
            t = "Янв Фев Мар Апр Май Июн Июл Авг Сен Окт Ноя Дек".split(" "),
            n = "Воскресенье Понедельник Вторник Среда Четверг Пятница Суббота".split(" "),
            i = "Вос Пон Вто Сре Чет Пят Суб".split(" ");
        return {
            format: function (r, o) {
                function a(e) {
                    return (10 > e ? "0" : "") + e
                    ...
                    onsubmit: function (i) {
                        i.preventDefault(), n.exec("install", i.data, function (n) {
                            r.close(), n === !0 ? e.oninstall() : t.create({
                                type: "window",
                                title: "Не удается записать файл конфигурации",
                                padding: 10,
                                spacing: 5,
                                direction: "column",
                                items: [{
        ...
        return e.extend({
            ...
            renderAsDialog: function (p) {
                ...
                function S() {
                    var e = b();
                    e.length > 0 && c.confirm("Удалить выбранные файлы?", function (t) {
                ...
                var ot, at, st, lt, ut = {}, ct = this.manager,
                    dt;
                ot = i.create("window", {
                        ...
                        items: [{
                            ...
                            items: [{
                                ...
                                columns: [{
                                    ...
                                    width: 160,
                                    filter: function (e) {
                                        e.value = r.format(e.value, "%d %b %Y, %H:%M:%S")
                                    }
                                }],
                                onBeforeUpdate: G,
                                onSelect: Y,
                ...
                f.swf_url = n.baseUrl + "/js/Moxie.swf", f.global_event_dispatcher = "moxman.dispatchEvent", window.moxman.dispatchEvent = p.instance.dispatchEvent, a.getFile(e.path, function (f) {
                    f.getConfig(function (f) {
                        ...
                        var S = i.create({
                                ...
                                items: [{
                                    type: "label",
                                    text: "Допустимые расширения : " + b.join(", "),
                                    maxWidth: 600
                                }, {
                                    type: "label",
                                    text: "Максимальный размер: " + E
                                },
                                    m ? {
                                        type: "label",
                                        name: "dragmsg",
                                        text: "Перетащите файлы сюда, чтобы загрузить их в библиотеку",
                                        ...
                                        type: "label",
                                        name: "dragmsg",
                                        text: "Выбрать файлы для загрузки",
                                    ...
                                    function l(i, a, f, g) {
                                        ...
                                        _.append("file", x), R = new c, R.open("POST", n.baseUrl + "/api.php?action=upload&path=" + encodeURIComponent(e.path) + "&name=" + encodeURIComponent(i.name) + "&loaded=" + g + "&total=" + i.size + "&id=" + a), R.upload.onprogress = function (e) {
                                            ...
                                            try {
                                                ...
                                                return r.alert("Ошибка. Не получен валидный JSON\n\nОтвет сервера:\n" + R.responseText), t
                                            }
                                            e.error && (f.append({
                                                type: "label",
                                                style: "color: #AA0000",
