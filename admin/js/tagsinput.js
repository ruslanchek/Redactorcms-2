...
(function($) {
			...
			this.each(function() { 
				...
				if (value !='' && skipTag != true) { 
                    $('<span>').addClass('tag').append(
                        ...
                        $('<a>', {
                            class : 'icon_action icon_delete_instance',
                            href  : 'javascript:void(0)'
                        }).click(function () {
                            return $.fn.removeTag(escape(value), id);
                        })
	...
	$.fn.removeTag = function(value, id) {
            if(typeof id != 'undefined'){
                value = unescape(value);

                $('#'+id).attr('id');

                var old = $('#'+id).val().split(delimiter[id]);
                ...
                $.fn.tagsInput.importTags($('#'+id),str);
	...
	$.fn.tagsInput = function(options) {
		...
		this.each(function() {
			...
			var markup = '<div id="'+id+'_tagsinput" class="tagsinput"><div class="add_tag" id="'+id+'_addTag">';

			if (settings.interactive) {
				markup = markup + '<input autocomplete="off" id="'+id+'_tag" value="" data-default="'+settings.defaultText+'" />' +
                '<a class="icon_action icon_add_instance" href="javascript:void(0)" onclick="$(this).prev().keydown()"></a>';
			}
