...
;(function($){
    ...
    $.fn.calendarLite.draw = function(opts) {
        ...
        var today = new Date();
        var srcDate = new Date(o.currentDate.substr(0, 4), o.currentDate.substr(5, 2)-o.cut);
        ...
        $this[0].innerHTML =
			'<span class="state" style="display:none;">' + curMonth + '.' + curYear + '</span><div class="monthName"><a href="javascript:void(0)" class="next">' + o.nextArrow + '</a><a href="javascript:void(0)" class="prev">' + o.prevArrow + '</a> ' + o.months[curMonth] + ',' + y + ' </div>';
        $this.append(table)
    ...
    $.fn.calendarLite.next = function(button, o) {
		...
		$('.table').find('a[rel='+o.currentDate+']').parent().removeClass('curr').addClass('sel');
    };
