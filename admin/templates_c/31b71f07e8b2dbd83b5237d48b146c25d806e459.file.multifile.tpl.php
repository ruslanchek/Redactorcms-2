<?php /* Smarty version Smarty 3.1.4, created on 2011-12-10 14:34:42
         compiled from "Z:/home/loc/redactorcms/admin/templates\system\fields_editor\multifile.tpl" */ ?>
<?php /*%%SmartyHeaderCode:23324ee343d21148a2-60704496%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '31b71f07e8b2dbd83b5237d48b146c25d806e459' => 
    array (
      0 => 'Z:/home/loc/redactorcms/admin/templates\\system\\fields_editor\\multifile.tpl',
      1 => 1322914709,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '23324ee343d21148a2-60704496',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_4ee343d2440de',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4ee343d2440de')) {function content_4ee343d2440de($_smarty_tpl) {?><?php if (!$_smarty_tpl->tpl_vars['default']->value){?>
...
<?php }?>"><?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_edit_item_label');?>
    			...
    			<td class="content_col">
    				<?php if ($_smarty_tpl->tpl_vars['new']->value){?>
			            <input class="textfield" type="text" value="<?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_editor_tools_multifile');?>
...
<?php }?>"><?php echo $_smarty_tpl->tpl_vars['main']->value->getText('sections','form_edit_item_file_customs');?>
    			...
    			<td class="content_col">
    				<input autocomplete="off" type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['item']->value['options_custom'];?>
...
<?php }?>" />
        ...
        <input type="hidden" value="multifile" name="type**__**<?php if ($_smarty_tpl->tpl_vars['new']->value){?><?php echo $_smarty_tpl->tpl_vars['new']->value;?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
<?php }?>" />
