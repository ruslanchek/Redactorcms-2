...
<div class="collapsable_fieldlist_item_tools">
    <fieldset>
    	<table cellpadding="0" cellspacing="0" border="0" class="item_tools_table">
    		<tr>
    			...
    			<td class="content_col">
    				{if $new}
			            <input class="textfield" type="text" value="{$main->getText('sections', 'form_editor_tools_tags')}" name="label**__**{$new}" id="label_new_{$item.new}" />
			        {else}
        ...
        <input type="hidden" value="tags" name="type**__**{if $new}{$new}{else}{$item.id}{/if}" />
