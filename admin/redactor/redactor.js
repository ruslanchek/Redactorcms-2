...
var RLANG = {
	...
	mailto: 'Email',
	web: 'URL',
	video_html_code: 'Вставить код видеоролика',
	file: 'Вставить файл',
	upload: 'Загрузить',
	download: 'Сквачать',
	choose: 'Выберите',
	or_choose: 'Выберите файл',
	drop_file_here: 'Перетащите файл сюда',
	align_left:	'Выравнивать текст по лувому краю',
	align_center: 'Выравнивать текст по центру',
	align_right: 'Выравнивать текст по правому краю',
	align_justify: 'Выравнивать текст по ширине',
	horizontalrule: 'Вставить горизонтальную полоску',
	deleted: 'Зачеркнутый',
	anchor: 'Якорь',
	link_new_tab: 'Открывать в новом окне',
