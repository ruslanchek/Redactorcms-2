    ...
    */
    class Utilities {
        ...
        static public function getUniqueCode($length = 6, $allow_uppercase = true, $allow_numbers = true){
         ...
         //Send mail
        public function sendMail($from_name, $from_mail, $to, $subject, $template, $data){
        ...
        static public function getCbValue($value){
            if($value == 'on' || $value == '1'){
                return '1';
            }else{
                return '0';
        ...
        //Purify string from metasymbols
        ...
        // TODO : Replace all admin functions from main.class with this one
